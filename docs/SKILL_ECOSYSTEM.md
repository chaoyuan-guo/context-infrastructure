...
| Agent operations | [ai_session_export](https://github.com/grapeot/ai_session_export) | 将多种 AI coding session 导出为统一 Markdown 归档 |
...
| Images | [image-generation-skill](https://github.com/grapeot/image-generation-skill) | Gemini / Imagen 图片生成 CLI，API key 和默认参数留在本地 overlay |
